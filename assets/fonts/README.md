...
Google Fonts. The typeface selector compares these combinations:
...
`fonts.css` and the WOFF2 files were retrieved through the Google Fonts CSS API on
2026-08-04. Only the Latin and Latin Extended subsets are included. Every family
is distributed under the SIL Open Font License 1.1; verbatim licence files are in
`licenses/`.
